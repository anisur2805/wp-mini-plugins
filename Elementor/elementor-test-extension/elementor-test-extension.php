...
final class Elementor_Test_Extension {
	...
	public function init() {
		...
		if( !did_action('elementor/loaded')) {
			add_action('admin_notices', [$this, 'admin_notice_main_plugin']);
			return;
		}
		...
		add_action('elementor/widgets/controls_registerd', [$this, 'init_controls']);
	 ...
	 * @access public
	 */
	public function admin_notice_main_plugin() {
		if( isset( $_GET['activate']) ) unset  ($_GET['activate']);
		$message = printf(
			/* translators: 1: Plugin name 2: Elementor */
			esc_html( __('"%1$s" requires "%2$s" version %3$s or greater .', 'elementor-test-extension' ), 
				'<strong>' .esc_html__('Elementor Test Extension', 'elementor-test-extension') . '</strong>'),
			'<strong>' . esc_html(__('Elementor', 'elementor-test-extension') . '</strong>'),
